        ...
        <div class="container">
                ...
                <div class="col-lg-4 pr-lg-5 p-0">
                    <div class="heading-area">
                        ...
                        <p class="paragraph">Our volunteers are always ready to help you.</p>
                    </div>
                    ...
                    <div id="owl-client" class="owl-carousel owl-theme">
                        ...
                        <div class="client-box">
                             <i class="lni-quotation q-icon"></i>
                                <p>I will be at your service anytime you require blood in Delhi 24*7.</p>
                        ...
                        <div class="client-box">
                           <i class="lni-quotation q-icon"></i> 
                            <p>Sometimes you just need someone, i am that someone whi can help you without anything in return.</p>
                        ...
                        <div class="client-box">
                            <i class="lni-quotation q-icon"></i> 
                            <p>Helping the needy is my hobby, and i am one the best at it..</p>
